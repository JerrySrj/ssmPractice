...
function toModifyRequestor(id){
	location.href = "toModifyRequestor?guid=" + id;
}

function toExamRequestor(id){
	location.href = "toExamRequestor?guid=" + id;
}
