...
<!-- Theme style -->
<link rel="stylesheet"
	href="${ctx}/plugins/AdminLTE-master/dist/css/AdminLTE.min.css">
<!-- AdminLTE Skins. We have chosen the skin-blue for this starter
        page. However, you can choose any other skin. Make sure you
        apply the skin class to the body tag so the changes take effect. -->
<link rel="stylesheet"
	href="${ctx}/plugins/AdminLTE-master/dist/css/skins/skin-blue.min.css">
...
<body class="hold-transition skin-blue sidebar-mini" >
	<div class="wrapper">
								...
								<li>
									<!-- start message --> <a href="#">
										<div class="pull-left">
											<!-- User Image -->
											<img
												src="${ctx}/plugins/AdminLTE-master/dist/img/user2-160x160.jpg"
		...
		<div class="user-panel">
			<div class="pull-left image">
				<img src="${ctx}/plugins/AdminLTE-master/dist/img/user2-160x160.jpg"
					class="img-circle" alt="User Image">
			</div>
		...
		<ul class="sidebar-menu" data-widget="tree">
			...
			<li class="active"><a href="#"><i class="fa fa-link"></i> <span>组织管理</span></a></li>
			<li><a href="#"><i class="fa fa-link"></i> <span>用户管理</span></a></li>
			<li class="treeview"><a href="#"><i class="fa fa-link"></i>
					<span>菜单管理</span> <span class="pull-right-container">
  ...
  immediately after the control sidebar -->
	...
	<!-- Bootstrap 3.3.7 -->
	<script
		src="${ctx}/plugins/AdminLTE-master/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
	<!-- AdminLTE App -->
	<script src="${ctx}/plugins/AdminLTE-master/dist/js/adminlte.min.js"></script>
