 ...
 * 
 */
@WebServiceClient(name = "WeatherWebService", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/E:/MyOwnProject/ApplicationHome/application-web-main/src/main/java/webServiceInterface/weather.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/E:/MyOwnProject/ApplicationHome/application-web-main/src/main/java/webServiceInterface/weather.wsdl");
