...
function initJobHandleLinesChart(flag) {
	var readChart = echarts.init(document.getElementById('jobReadLinesChart'), 'macarons');
	var writeChart = echarts.init(document.getElementById('jobWrieteLinesChart'), 'macarons');
	var inputChart = echarts.init(document.getElementById('jobInputLinesChart'), 'macarons');
	var outputChart = echarts.init(document.getElementById('jobOutputLinesChart'), 'macarons');
	var updateChart = echarts.init(document.getElementById('jobUpdateLinesChart'), 'macarons');
	var rejectedChart = echarts.init(document.getElementById('jobRejectedLinesChart'), 'macarons');
